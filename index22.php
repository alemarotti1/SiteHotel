    ...
    <div id="wrapper">
      ...
      <section id="intro" class="wrapper style1 fullscreen fade-up">
        <div class="inner" style="padding: 20px 0">			
			<p align="center"><img class="logohotel" src="img/logo.png" /></p>			
			<p align="center">O Hotel Alê tem jeitinho de casa do interior!</p>
			<p align="justify">É para quem gosta das coisas simples da vida, como tomar um café, estar entre amigos ou passar uns dias com a família. Fica bem perto de restaurantes, bares, bancos, pontos de ônibus e comércio (inclusive de lingerie). Tem fácil acesso às principais atrações turísticas da cidade.</p>
		    <p align="center">Possui quartos de casal, triplo, de familia e idividual.</p>
			<br/>
			<p style="text-align: center"><a href="#one" class="button scrolly" style="background: #F57663; color: #fff;">Veja os quartos</a></p>			
        </div>
      </section>
      <!-- One -->  
					...
					<div class="itemGrid1" style="width:100%">
						...
						<div class="quarto">
							...
							<div class="txtq">
								...
								<p style="color: green; font-weight: bold;"><img src="img/banheiro.png"> Valor: 270,00</p>									
								...
								<div class="booking"><a alt="Fale Conosco" title="Fale Conosco" href="https://wa.me/message/CA47NOMUZZ56B1" target="_blank"><img src="img/FaleConoscoWhatsApp.png" width="80" height="23" alt=""/></a></div>
						...
						<div class="quarto">
							...
							<div class="txtq">
								...
								<p style="color: green; font-weight: bold;"><img src="img/banheiro.png"> Valor: 320,00</p>						
						...
						<div class="quarto">
							...
							<div class="txtq">
								...
								<p><img src="img/banheiro.png"> Amplo banheiro privativo com secador de cabelo</p>
								<p><img src="img/frigobar.png"> Frigobar</p>
								<p style="color: green; font-weight: bold;"><img src="img/banheiro.png"> Valor: 220,00</p>									
						...
						<div class="quarto">
							...
							<div class="txtq">
								...
								<p><img src="img/frigobar.png"> Frigobar</p>
								<p style="color: green; font-weight: bold;"><img src="img/banheiro.png"> Valor: 198,00</p>									
						...
						<div class="quarto">
							...
							<div class="txtq">
								...
								<p style="color: red; font-weight: bold;">Quarto indisponível devido à pandemia</p>
								<!--p style="color: green; font-weight: bold;"><img src="img/banheiro.png"> Valor: </p-->									
						...
						<div class="quarto text-center">
								
								<button type="button" href="https://hotelale.ibookingpms.com.br/motor-de-reservas/" class="btn btn-success"><h3>Faça já sua reserva</h3></button>
            ...
            <section>
              <ul class="contact">
                ...
                <li>
                  ...
                  <ul class="icons">
                    <li><a class="fa-twitter" style="color: #222"><span class="label">Twitter</span></a></li>
                    ...
                    <li><a href="#" class="fa-linkedin" style="color: #222"><span class="label">LinkedIn</span></a></li>
                  </ul>
                </li>
              </ul>
